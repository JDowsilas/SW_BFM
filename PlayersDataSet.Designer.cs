...
namespace SW_BFM {
    ...
    public partial class PlayersDataSet : global::System.Data.DataSet {
        ...
        public partial class PlayersDataTable : global::System.Data.TypedTableBase<PlayersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PlayersRow AddPlayersRow(string Username, int Score) {
        ...
        public partial class PlayersRow : global::System.Data.DataRow {
            ...
            public int Score {
                get {
                    return ((int)(this[this.tablePlayers.ScoreColumn]));
                }
                set {
                    this[this.tablePlayers.ScoreColumn] = value;
                }
            }
        }
...
namespace SW_BFM.PlayersDataSetTableAdapters {
    ...
    public partial class PlayersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Players] WHERE (([Id] = @Original_Id) AND ([Username] = @Origi" +
                "nal_Username) AND ([Score] = @Original_Score))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Players] ([Id], [Username], [Score]) VALUES (@Id, @Username, @" +
                "Score);\r\nSELECT Id, Username, Score FROM Players WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Players] SET [Id] = @Id, [Username] = @Username, [Score] = @Score W" +
                "HERE (([Id] = @Original_Id) AND ([Username] = @Original_Username) AND ([Score] =" +
                " @Original_Score));\r\nSELECT Id, Username, Score FROM Players WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SW_BFM.Properties.Settings.Default.cn;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Username, Score FROM dbo.Players";
        ...
        public virtual int Insert(int Id, string Username, int Score) {
        ...
        public virtual int Update(int Id, string Username, int Score, int Original_Id, string Original_Username, int Original_Score) {
